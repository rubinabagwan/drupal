...
/* themes/contrib/mytheme/templates/node/node--article.html.twig */
class __TwigTemplate_9f6b6017fec1c5dae8334e04b873a6230f13abbe654f5e6e842042e7a33a8fba extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (\Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 74, $this->source))) : ("")), 5 => "clearfix"];
  ...
  ";
      ...
      <div";
        ...
        ";
            // line 92
            echo t("Submitted by Rubina @author_name on @date", array("@author_name" => ($context["author_name"] ?? null), "@date" => ($context["date"] ?? null), ));
            // line 93
            echo "        ";
...
";
    ...
    {
        return "themes/contrib/mytheme/templates/node/node--article.html.twig";
    }
  ...
  {% if display_submitted %}
    <footer>
      ...
      <div{{ author_attributes.addClass('author') }}>
        {% trans %}Submitted by Rubina {{ author_name }} on {{ date }}{% endtrans %}
        {{ metadata }}
      </div>
    </footer>
  {% endif %}
...
", "themes/contrib/mytheme/templates/node/node--article.html.twig", "C:\\xampp\\htdocs\\newdemo\\themes\\contrib\\mytheme\\templates\\node\\node--article.html.twig");
    }
